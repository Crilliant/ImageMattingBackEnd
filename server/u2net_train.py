...
# 从图片路径(orgin)获取图片名字，Png后缀
def get_label_name(img_path):
...
tra_image_dir = r'origin/'
tra_label_dir = r'mask/'

label_ext = '.png'

model_dir = os.path.join(os.getcwd(), 'new_saved_models', model_name + os.sep)
...
for img_path in tra_img_name_list:
    img_name = get_label_name(img_path)
    tra_lbl_name_list.append(data_dir + tra_label_dir + img_name)
...
train_num = len(tra_img_name_list)  # 5711
